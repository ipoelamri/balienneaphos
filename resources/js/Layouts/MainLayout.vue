...
<template>
    <div class="bg-button-dark text-text-light">
        ...
        <footer
            class="relative z-10 bg-white dark:bg-button-dark pt-20 pb-10 lg:pt-[120px] lg:pb-20"
        >
                ...
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                        <div class="w-full mb-10">
                            ...
                            >
                                PT. Bali Ennea Phos is a trusted construction
                                and project management company with a reputation
                                as one of the best in Bali.
                            </p>
                            <p
